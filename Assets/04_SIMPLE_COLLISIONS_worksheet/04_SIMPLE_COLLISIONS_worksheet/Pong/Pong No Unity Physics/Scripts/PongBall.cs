...
namespace pool
{
    public class PongBall : MonoBehaviour
    {
        ...
        void HandleBoundaryCollision()
        {
            ...
            if (ballRight > rightWall.transform.position.x - wallOffset)
            {
                if (speedX > 0f)
                {
            ...
            if (ballLeft < leftWall.transform.position.x + wallOffset)
            {
                if (speedX < 0f)
                {
            ...
            if (ballTop > topWall.transform.position.y - wallOffset)
            {
            ...
            if (ballBottom < bottomWall.transform.position.y + wallOffset)
            {
